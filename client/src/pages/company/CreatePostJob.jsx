...
function CreatePostJob(props) {
    ...
    const handleInsertJob = async (e) => {
        ...
        try {
            ...
            let res = await jobPostService.insertJobPost({ ...jobPost, description: descrRef.current.getContent(), applicant_requirements: reqRef.current.getContent(), benefits: benefitRef.current.getContent() });
            if (res.error) {
                return;
            }
                        ...
                        <div>
                            <form className="row g-3" onSubmit={handleInsertJob}>
                                <div className="col-md-12">
                                    ...
                                    <input type="text" className="form-control form-control-lg" id="inputJob4" name='title' onChange={handleInput} />
                                </div>
                                <div className="col-md-6">
                                    <label htmlFor="inputPassword4" className="form-label">location</label>
                                    <input className="inputselectLocation form-control form-control-lg border-end" list="datalistOptions" id="exampleDataList" type='search' placeholder="Location" name='location' onChange={handleInput} />
                                    ...
                                    <div className="col-12">
                                        ...
                                        <div className="row g-2">
                                            ...
                                            <div className="col-6">
                                                ...
                                                <div className="input-group mb-3">
                                                    <input type="number" className="form-control form-control-lg" placeholder="Maximun salery..." name='salary' aria-label="Maximun salery..." aria-describedby="basic-addon3" onChange={handleInput} />
                                ...
                                <div className="col-12">
                                    ...
                                    <div className="row g-3">
                                        <div className="col-4">
                                            ...
                                            <select className="form-select form-control-lg" id="required_experience" name='required_experience' onChange={handleInput}>
                                        ...
                                        <div className="col-4">
                                            ...
                                            <select className="form-select form-control-lg" id="work_status" name='work_status' onChange={handleInput}>
                                        ...
                                        <div className="col-4">
                                            ...
                                            <input type="number" className="form-control form-control-lg" placeholder="10" name='quantity' aria-label="quantity" aria-describedby="basic-addon2" onChange={handleInput} />
                                        </div>
                                        <div className="col-4 mx-auto">
                                            <label htmlFor="inputAddress" className="form-label">Dealine time</label>
                                            <input type="date" className="form-control" onFocus={() => setMinAndDefaultDate(refDate,null)} ref={refDate} name='deadline' onChange={handleInput} />
                                        </div>
                                    </div>
