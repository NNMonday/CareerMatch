              ...
              <div className="row">
                <div className="col-6 col-md-6 col-lg-6">
                  <div className="group-info-company d-flex align-items-center">
                    <div className="">
                      <img
                        src={objCompany.imgage_avatar}
                        className="rounded-circle"
                        alt={objCompany.imgage_avatar}
                        srcSet=""
                        width={96}
                        height={96}
                      />
                    ...
                    <div className="group-title-job">
                      <div className="title-job ">
                        <p className="fw-bold fs-3 mb-0 position-relative">
                          {job.title}
                          <span className="sub-status position-absolute">
                            {job.work_status}
                          </span>
                        </p>
                      </div>
                ...
                <div className="col-3 col-md-3 col-lg-3 offset-3 offset-md-3 offset-lg-3">
                  <button
                    type="button"
                    className="btn btn-primary px-5 py-3 mt-3 rounded-0"
                  >
                    Apply Now 👈🏼
                  </button>
                  <p className="mt-2">
                ...
                <div className="col-5 col-md-5 col-lg-5 ">
                  ...
                  <div className="group-infoJob jobOverview">
                    <div className="item-info">
                      ...
                      <p className="title-info text-uppercase fs-6 my-3">
                        Job Posted:
                      </p>
                      <p className="fw-bold">
                        {" "}
                        {convertFormat(job.createdAt)}{" "}
                      </p>
                    </div>
                    <div className="item-info">
                      <div className="item-info-icon">
      ...
      <div className="modal-dialog modal-dialog-centered">
        <div className="modal-content">
          <div className="modal-header bg-danger">
            <h5 className="modal-title text-white" id="confirmlabel">
              Wait!
            </h5>
            <button
              type="button"
  ...
  return (
    <tr key={data.id}>
      <th scope="row">
        <div className="job-title">
          ...
          <div className="sub-content">
            <span>{data?.work_status}</span> .{" "}
            <span>{ConvertDayRemaining(data?.deadline)}</span>
          </div>
        </div>
      </th>
      <td>
      ...
      <td>
        <Link
          to={""}
          className="btn rounded-0 btn-dark px-4 py-3"
          data-bs-toggle="modal"
          data-bs-target="#exampleModal"
          onClick={() => setjobId(data?.id)}
        >
          View details
        </Link>
        <div className="btn-group">
          ...
          >
            <path
              d="M24 25.125C24.6213 25.125 25.125 24.6213 25.125 24C25.125 23.3787 24.6213 22.875 24 22.875C23.3787 22.875 22.875 23.3787 22.875 24C22.875 24.6213 23.3787 25.125 24 25.125Z"
              fill="#767F8C"
              stroke="#767F8C"
            />
            <path
              d="M24 18.6504C24.6213 18.6504 25.125 18.1467 25.125 17.5254C25.125 16.9041 24.6213 16.4004 24 16.4004C23.3787 16.4004 22.875 16.9041 22.875 17.5254C22.875 18.1467 23.3787 18.6504 24 18.6504Z"
              fill="#767F8C"
              stroke="#767F8C"
            />
            <path
              d="M24 31.6104C24.6213 31.6104 25.125 31.1067 25.125 30.4854C25.125 29.864 24.6213 29.3604 24 29.3604C23.3787 29.3604 22.875 29.864 22.875 30.4854C22.875 31.1067 23.3787 31.6104 24 31.6104Z"
              fill="#767F8C"
              stroke="#767F8C"
            />
          </svg>
          ...
          <ul className="dropdown-menu dropdown-menu-end dropdown-menu-lg-start">
            <li className="p-1 text-center">
              <Link to={`/update-a-job?id=${data?.id}`}>
                Update job posting
              </Link>
            </li>
            <li
